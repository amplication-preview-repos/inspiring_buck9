...
@InputType()
class ScaffoldingCreateNestedManyWithoutClientsInput {
...
export { ScaffoldingCreateNestedManyWithoutClientsInput as ScaffoldingCreateNestedManyWithoutClientsInput };
