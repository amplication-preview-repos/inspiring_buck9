...
import { ScaffoldingFindManyArgs } from "../../scaffolding/base/ScaffoldingFindManyArgs";
...
export class ClientControllerBase {
  ...
  async findProjects(
    ...
    const query = plainToClass(ScaffoldingFindManyArgs, request.query);
  ...
  async connectProjects(
    @common.Param() params: ClientWhereUniqueInput,
    @common.Body() body: ScaffoldingWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      projects: {
        connect: body,
