...
@InputType()
class MaterialCreateNestedManyWithoutScaffoldingsInput {
...
export { MaterialCreateNestedManyWithoutScaffoldingsInput as MaterialCreateNestedManyWithoutScaffoldingsInput };
